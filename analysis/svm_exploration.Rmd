...
For the SVM algorithm we also implemented a simple search pattern for optimal 
parameters for the regularization parameter `C` and the kernel width `γ`. We did
...
Finally, we can apply this function to the different levels of preprocessing which
...
score of about 0.75. We can look at this more mathematically by calculating the average 
